...
- Immediate: Default to string with a constraints field noting the expected structure.
  Return gaps_found: "Field {field_name} in event {event_name} replaced with string — actual type requires domain clarification; review before arch-executor runs agent contracts."
