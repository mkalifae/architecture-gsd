...
**Trigger:** Under context pressure or when the failure trigger is abstract (e.g., "system failure"), failure-analyst writes recovery sections using vague language: "handles gracefully", "retries automatically", "logs error and continues processing." detect-stubs flags these as stub phrases.
