...
**If status is "human_needed":**
  ...
  To continue, inspect .arch/CONTEXT.md, correct the structural issues described above, then re-run /arch-gsd:new-system. discuss-system will load the corrected file in update mode."
...
**If status is "partial":**
  ...
  Re-run /arch-gsd:new-system to continue. discuss-system will load what was collected and resume from where you left off."
