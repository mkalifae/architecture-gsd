...
```yaml
locked-decisions:
  - decision: "Standalone system, not a plugin mode"
    rationale: "Clean separation of concerns — architecture domain expertise should not pollute code-domain tooling"
